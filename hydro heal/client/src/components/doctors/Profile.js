...
const Profile = () => {
    ...
    useEffect(() => {
        axios
            .get(`http://localhost:5000/doctor/${regno}`)
            .then((res) => {
    ...
    useEffect(() => {
        axios
          .get("http://localhost:5000/allpatients")
          .then((res) => {
        ...
        if (image) {
            ...
            fetch("	https://api.cloudinary.com/v1_1/xmeme-image-store/image/upload", {
                ...
                .then(data => {
                    ...
                    axios.put("http://localhost:5000/updatepicofdoctor", newpic)
                        .then(result => {
    ...
    const AddPatient = () => {
        ...
        axios.post("http://localhost:5000/addpatientinlist", newpatient)
            .then(result => {
