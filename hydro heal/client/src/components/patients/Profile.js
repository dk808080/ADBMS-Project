...
const Profile = () => {
        ...
        if (image) {
            ...
            fetch("	https://api.cloudinary.com/v1_1/xmeme-image-store/image/upload", {
                ...
                .then(data => {
                    ...
                    axios.put("http://localhost:5000/updatepicofpatient", newpic)
                        .then(result => {
        ...
        if (report) {
            ...
            fetch("	https://api.cloudinary.com/v1_1/xmeme-image-store/image/upload", {
                ...
                .then(data => {
                    ...
                    axios.put("http://localhost:5000/updatereport", newreport)
                        .then(result => {
    ...
    const AddReport = () => {
        ...
        axios.post("http://localhost:5000/addreport", newreport)
            .then((res) => {
